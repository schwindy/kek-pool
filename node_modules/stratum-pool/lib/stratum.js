...
var StratumClient = function(options) {
    ...
    var considerBan = (!banning || !banning.enabled) ? function() {
        return false } : function(shareValid) {
        ...
        _this.emit('subscription', {},
            function(error, extraNonce1, extraNonce2Size) {
                ...
                sendJson({
                    ...
                    params: [crypto.pseudoRandomBytes(32).toString('hex'), options.subscriptionId]
                })
...
=======
                    ...
                    catch(e)
                    {
                        if(options.tcpProxyProtocol !== true || d.indexOf('PROXY') !== 0)
                        {
                            console.log("Malformed Message: ", messageJson);
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
    ...
    this.sendTarget = function(target) {
        sendJson({
            id: null,
    ...
    // JobParams -> mining.notify
    // jobParams.notify -> mining.notify
    // jobParams.set_target -> mining.set_target
...
<<<<<<< HEAD
        ...
        console.log(jobParams.notify);
        console.log("********************")
        sendJson({
            id: null,
            method: "mining.notify",
            params: jobParams.notify
=======
        sendJson({
            id    : null,
            method: "mining.set_target",
            params: jobParams.setTarget
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
        });
...
=======
        ...
        //console.log(jobParams.setTarget);
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
