...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.updateCurrentJob = function(rpcData, workRestart) {
...
<<<<<<< HEAD
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, nTime, nonce, ipAddress, port, workerName, solution, solutionSize, hashReserved) {
...
=======
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName)
    {
        ...
        var shareError = function(error){
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
            _this.emit('share', {
                job: jobId,
                ip: ipAddress,
                worker: workerName,
...
<<<<<<< HEAD
        var jobId = this.validJobs
=======
        if (extraNonce2.length / 2 !== _this.extraNonce2Size * 1.5)
            return shareError
            (
                [
                    20,
                    'incorrect size of extranonce2 - nonce received: '+extraNonce2+'(len:'+extraNonce2.length+')|'+
                    'expected length : '+_this.extraNonce2Size*2+'',
                ]
            );
...
<<<<<<< HEAD
        ...
        // }
=======
        //if (nTime.length !== 8)nTime = (Date.now() / 1000).toString('hex');
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
...
=======
        if(nonce.length !== 8)
            ...
            (
                [
                    20,
                    'Invalid nonce length - received: '+nonce+'(len:'+nonce.length+')|'+
                    'expected length : 8',
                ]
            );
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
        ...
        var coinbaseBuffer = job.serializeCoinbase(extraNonce1Buffer);
        ...
        var headerBuffer = job.serializeHeader(merkleRoot, nTime, nonce, solution, solutionSize, hashReserved);
        ...
        if (job.target.ge(headerBigNum)) {
            ...
            console.log('Blockhex below');
            console.log(blockHex);
            console.log('blockHash below');
