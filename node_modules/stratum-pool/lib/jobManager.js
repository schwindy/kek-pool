...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        console.log(jobId);
        console.log(previousDifficulty);
        console.log(difficulty);
        console.log(extraNonce1);
        console.log(extraNonce2)
        console.log(nTime);
        console.log(nonce)
        ...
        console.log('extraNonce2 length: ' + extraNonce2.length);
        console.log('example size length: ' +  _this.extraNonce2Size)
        if (extraNonce2.length / 2 !== _this.extraNonce2Size)
            return shareError([20, 'incorrect size of extranonce2 - nonce received: ' + extraNonce2 + ', expected nonced length : ' + _this.extraNonce2Size*2]);
        ...
        if (nTime.length !== 8) {
            return shareError([20, 'incorrect size of ntime, ntime received: ' + nTime + ', expected ntime length: 8']);
        }
        ...
        if (nonce.length !== 8) {
            return shareError([20, 'incorrect size of nonce - nonce received: ' + extraNonce1 + ', expected nonce size: 8']);
        }
