...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function SubmitBlock(blockHex, callback){
        ...
        if (options.hasSubmitMethod){
            console.log('SUBMITTED BLOCK LIKE A BOSS')
...
>>>>>>> eefd67c40b01cfafd9f6be511643b0b45171f5ad
                ...
                _this.jobManager.updateCurrentJob(rpcData, 'noRestart');
            });
        }).
        on('client.connected', function(client)
        {
            ...
            {
                emitErrorLog('Client IP Error: tcpProxyProtocol is enabled yet did not receive message: '+data);
            }).
            on('bootedBannedWorker', function()
            {
                emitWarningLog('Booted worker ' + client.getLabel() + ' connected from an IP banned address');
            }).
